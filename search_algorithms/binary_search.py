...
# test cases
print(binary_search_iter([5,6,7,8,9], 9))
print(binary_search_iter([5,6,7,8,9], 10))
print(binary_search_iter([5,6,7,8,9], 8))
print(binary_search_iter([5,6,7,8,9], 4))
print(binary_search_iter([5,6,7,8,9], 6))